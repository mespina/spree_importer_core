  ...
  module ImporterCore
    module Generators
      class InstallGenerator < Rails::Generators::Base
        ...
        def add_stylesheets
          inject_into_file 'vendor/assets/stylesheets/spree/frontend/all.css', " *= require spree/frontend/spree_importer_core\n", :before => /\*\//, :verbose => true
          inject_into_file 'vendor/assets/stylesheets/spree/backend/all.css', " *= require spree/backend/spree_importer_core\n", :before => /\*\//, :verbose => true
        end
        ...
        def include_spree_importer_core_from_lib
          inject_into_file 'config/application.rb', "# Load application's importers
    Dir.glob(File.join(File.dirname(__FILE__), \"../lib/spree_importer_core/*_importer.rb\")) do |c|
